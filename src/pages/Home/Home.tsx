        ...
        <div className="row container">
          <div className="section__col" data-aos="fade-down" data-delay="1500">
            <picture>
              ...
              <img className="img-fluid" src={aboutImgXs} alt="example dish from our restaurant" loading="lazy" />
            </picture>
            <picture>
              <source media="(min-width: 475px)" srcSet={about1Img} />
              <img className="img-fluid" src={about1ImgXs} alt="example dish from our restaurant" loading="lazy" />
            </picture>
          </div>
          <article
